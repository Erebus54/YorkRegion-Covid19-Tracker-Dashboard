...
plot_ly(data = acq_daily, 
  ...
  add_trace(y = ~`Missing Information`, 
            name = "Missing Information", marker = list(color = "#DCDCDC")) %>% 
  add_trace(y = ~`No known epi link`, name = "No known epi link", marker = list(color = "#D3D3D3")) %>% 
  add_trace(y = ~`Unspecified epi link`, name = "Unspecified epi link", marker = list(color = "#C0C0C0")) %>% 
